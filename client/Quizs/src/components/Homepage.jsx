...
const Homepage = () => {
  return (
      <div style={{paddingBottom:"5rem", background:"#F7F7F8"}}>
          <Navbar/>
          ...
          <VStack mt={"14rem"} >
              ...
              <HStack w={"100%"} pl={"7rem"} justifyContent={"space-between"} pr={"5rem"} mt={"2rem"}>
                  <VStack h={"37rem"} border={"2px solid white"} borderRadius={"8px"} background={"white"} w={"47%"}>
                      ...
                      <Button w={"100%"} background={"#FF9500"} h={"3rem"} mt={"2rem"} color={"white"} _hover={"none"}>Explore Now</Button>
                  </VStack>
                  <VStack h={"37rem"} border={"2px solid white"} borderRadius={"8px"} background={"white"} w={"47%"}>
              ...
              <HStack w={"100%"} pl={"7rem"} justifyContent={"space-between"} pr={"5rem"} mt={"2rem"} pb={"6rem"} background={"##F7F7F8"}>
                  <VStack h={"37rem"} border={"2px solid white"} borderRadius={"8px"} background={"white"} w={"47%"}>
                      ...
                      <Button w={"100%"} h={"3rem"} background={"#FF9500"} mt={"2rem"} color={"white"} _hover={"none"}>Explore Now</Button>
                  </VStack>
                  <VStack h={"37rem"} border={"2px solid white"} borderRadius={"8px"} background={"white"} w={"47%"}>
